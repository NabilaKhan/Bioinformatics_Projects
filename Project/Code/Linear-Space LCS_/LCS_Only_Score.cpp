...
//**********************copying the LL array in reverse order to another file************************************
   /* outfile.close();
    outfile.open("Sequence with William Syndrome/output1.txt");
    reversed.open("Sequence with William Syndrome/output3.txt");
    reversed<<"start"<<endl;

    string line2;
    while(getline(outfile,line2)){

      temp.open("Sequence with William Syndrome/output2.txt");
      temp<<line2<<endl;
     // cout<<line2<<endl;
      //cout<<"ok"<<endl;
      reversed.seekg(0);
